...
- Name: readCSV.spec.js >> Validating CSV to DataDriven 2
- Location: tests\readCSV.spec.js:18:9
...
Call log:
  ...
  - waiting for locator('[id="logout2"]')
    18 × locator resolved to <a href="#" id="logout2" class="nav-link" onclick="logOut()">Log out</a>
