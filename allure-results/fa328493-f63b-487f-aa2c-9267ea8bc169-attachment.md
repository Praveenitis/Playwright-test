...
```
TypeError: this.page.waitForSelectors is not a function
```
    ...
    - list [ref=e6]:
      ...
      - listitem [ref=e16]:
        - link "Log out" [ref=e17] [cursor=pointer]:
          - /url: "#"
      - listitem [ref=e18]:
        - link "Welcome Raviteja18" [ref=e19] [cursor=pointer]:
          - /url: "#"
      - listitem
    - generic [ref=e21]:
      - list [ref=e22]:
...
```ts
  ...
  2  | 
  3  | export class CommonActions{
  4  |     constructor(page){
  5  |         this.page = page;
  6  | 
  7  |     }
  8  | 
  9  |     async Click(locator){
  10 |         await this.page.locator(locator).click()
  11 |     }
  12 | 
  13 |     async Fillaction(locator,value){
  14 |         await this.page.locator(locator).fill(value)
  15 |     }
  16 | 
  17 |     async waitForLocator(locator){
  18 |         await this.page.locator(locator).waitFor()
  19 |     }
  20 | 
  21 |     async waitForSelectors(locator){
> 22 |         await this.page.waitForSelectors(locator)
     |                         ^ TypeError: this.page.waitForSelectors is not a function
  23 |     }
  24 |     async tohaveUrl(value){
  25 |         await expect(this.page).toHaveURL(value)
  26 |     }
  27 | 
  28 |     async getText(locator){
  29 |         await this.page.locator(locator).textContent()
  30 |     }
  31 | 
  32 |     async isVisible(locator){
  33 |         await expect(this.page.locator(locator)).toBeVisible()
  34 |     }
  35 | }
```