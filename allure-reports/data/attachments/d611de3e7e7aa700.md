...
```ts
  ...
  13 | 
> 14 |     await page.locator('[class^="wp-block-button__link"]').toBeVisible() //PREFIX
     |                                                            ^ TypeError: page.locator(...).toBeVisible is not a function
  15 |     await page.locator('[class$="-credit"]').toBeVisible() //SUFFIX
  16 |     await page.locator(['[class*="text-color has-background has-very-dark-gray-"]']).toBeVisible()
  17 |     //SUBSTRING
  18 | 
  19 | 
